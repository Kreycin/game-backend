...
export interface ApiCharacterCharacter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ATK: Schema.Attribute.Integer;
    Avatar: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    Character_ID: Schema.Attribute.UID<'Name'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CRIT_DMG: Schema.Attribute.String;
    CRIT_DMG_Res: Schema.Attribute.String;
    CRIT_rate: Schema.Attribute.String;
    CRIT_Res: Schema.Attribute.String;
    Debuff_Acc: Schema.Attribute.String;
    Debuff_Res: Schema.Attribute.String;
    DEF: Schema.Attribute.Integer;
    DMG_Res: Schema.Attribute.String;
    Doge: Schema.Attribute.String;
    Element: Schema.Attribute.Enumeration<['Legend', 'Demon']>;
    Extra_DMG: Schema.Attribute.String;
    Healing_Amt: Schema.Attribute.String;
    Healing_Amt_P: Schema.Attribute.String;
    HP: Schema.Attribute.Integer;
    Lifesteal: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    Main_Art: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    Name: Schema.Attribute.String & Schema.Attribute.Required;
    Penetration: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    Rarity: Schema.Attribute.Enumeration<['UR', 'SP', 'SSR']>;
    Role: Schema.Attribute.String;
    SPD: Schema.Attribute.Integer;
    Star_Levels: Schema.Attribute.Component<'character.star-level-data', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEffectEffect extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    Effect_Name: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::effect.effect'
...
export interface ApiEnhancementEnhancement extends Struct.CollectionTypeSchema {
  collectionName: 'enhancements';
  info: {
    displayName: 'Enhancement';
    pluralName: 'enhancements';
    singularName: 'enhancement';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    effects: Schema.Attribute.Relation<'manyToMany', 'api::effect.effect'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    owner: Schema.Attribute.Relation<'oneToMany', 'api::build.build'>;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
